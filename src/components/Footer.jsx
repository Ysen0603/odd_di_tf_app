      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-wrap justify-between">
          ...
          >
            ...
            <p className="text-blue-200">Empowering mental health professionals with AI-driven insights.</p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="flex space-x-4">
              <a href="https://twitter.com/oddditf" className="text-blue-200 hover:text-white transition duration-300">
                <FaTwitter size={24} />
              </a>
              <a href="https://linkedin.com/company/oddditf" className="text-blue-200 hover:text-white transition duration-300">
                <FaLinkedin size={24} />
              </a>
              <a href="https://github.com/oddditf" className="text-blue-200 hover:text-white transition duration-300">
                <FaGithub size={24} />
              </a>
            </div>
          </motion.div>
        </div>
        <div className="border-t border-blue-400 mt-8 pt-8 text-sm text-center text-blue-200">
